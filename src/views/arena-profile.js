        ...
        <div className="arena-profile-navbar">
          <div className="arena-profile-left-side">
            ...
            <div className="arena-profile-links-container">
              ...
              <Link
                ...
                className="arena-profile-link1 Anchor"
              >
                LEADERBOARD
              </Link>
          ...
          <div className="arena-profile-container1">
            <Link to="/arena-profile" className="arena-profile-navlink">
              <svg viewBox="0 0 1024 1024" className="arena-profile-icon2">
          ...
          <div data-role="MobileMenu" className="arena-profile-mobile-menu">
            <div className="arena-profile-container2">
              ...
              >
                <svg viewBox="0 0 1024 1024" className="arena-profile-icon4">
...
export { ArenaProfile, update, putUserDetails, checkIfDetailsValid };
