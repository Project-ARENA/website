...
const About = (props) => {
  return (
    <div className="about-container">
      <Helmet>
        <title>About - Project ARENA</title>
        <meta property="og:title" content="About - Project ARENA" />
      </Helmet>
        ...
        <div className="about-navbar">
          <div className="about-left-side">
            ...
            <div className="about-links-container">
              ...
              <span className="about-link3 Anchor">ABOUT</span>
            </div>
          </div>
          <div className="about-right-side">
            <Link to="/register1" className="about-cta-btn button">
              PROJECT PORTAL
            </Link>
          </div>
