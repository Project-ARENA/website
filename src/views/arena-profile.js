...
const ArenaProfile = (props) => {
  ...
  return (
    <div className="arena-profile-container">
      <div
        data-role="Header"
        className="arena-profile-navbar-container"
      >
        <div className="arena-profile-navbar">
          <div className="arena-profile-left-side">
            ...
            <div
              ...
              className="arena-profile-burger-menu"
            >
              <svg
                viewBox="0 0 1024 1024"
                className="arena-profile-icon"
              >
                <path d="M128 256h768v86h-768v-86zM128 554v-84h768v84h-768zM128 768v-86h768v86h-768z"></path>
              </svg>
            </div>
              <Link to="/player-portal-competitions" className="arena-main-link">
            ...
            <div className="arena-profile-links-container">
              <Link to="/arena-main" className="arena-main-link">
                  ARENA
              </Link>
              <Link to="/arena-submissions" className="arena-profile-link">
                SUBMISSIONS
              </Link>
              <Link to="/arena-leaderboard" className="arena-profile-link1 Anchor">
                LEADERBOARD
              </Link>
              <Link to="/arena-team" className="arena-profile-link2 Anchor">
                TEAM
              </Link>
            </div>
          </div>
          <div className="arena-profile-container1">
            <Link to="/arena-profile" className="arena-profile-navlink">
              <svg
                viewBox="0 0 1024 1024"
                className="arena-profile-icon2"
              >
          ...
          <div
            ...
            className="arena-profile-mobile-menu"
          >
            <div className="arena-profile-container2">
              ...
              >
                <svg
                  viewBox="0 0 1024 1024"
                  className="arena-profile-icon4"
                >
                  <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                </svg>
              </div>
            </div>
            <div className="arena-profile-links-container1">
              <Link to="/arena-submissions" className="arena-profile-link">
                SUBMISSIONS
              </Link>
              <Link to="/arena-leaderboard" className="arena-profile-link1 Anchor">
      ...
      <div className="arena-profile-section-separator"></div>
      <div className="arena-profile-section-separator1"></div>
      <div className="arena-profile-section-separator2"></div>
      <div className="arena-profile-section-separator3"></div>
      <div className="arena-profile-container3" onSubmit={handleSubmit}>
        <span className="arena-profile-text">UPDATE PROFILE</span>
        <InputBoxForInfo
